...
**YOU ARE IN: `trend/polecats/nitro/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/trend/` (rig root) or other directories
...
**Your mail address:** `trend/polecats/nitro`
**Your rig:** trend
**Your Witness:** `trend/witness`
...
| Ask Witness for help | `gt mail send trend/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`trend/witness`) when:
...
```bash
gt mail send trend/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
